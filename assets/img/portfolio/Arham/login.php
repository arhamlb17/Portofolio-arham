                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login E-Perpus </h3></div>
                                    <div class="card-body">
                                            <?php
                                            // ketika tombol login ditekan
                                            if (isset($_POST['login'])) {
                                                // tangkap data userername dan pass dari form
                                                ...
                                                // =  SELECT*FROM user WHERE username="maknende" and password="makn"
                                                $data = mysqli_query($koneksi, "SELECT*FROM user
                                                    WHERE username='$username' and password='$password'");
                                                    // mrnghitung jumlah baris dalam database 
